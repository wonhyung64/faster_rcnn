...
def build_args():
    ...
    parser.add_argument("--anchor-ratios", nargs="+", type=float, default=[1.0, 2.0, 1.0 / 2.0])
    parser.add_argument("--anchor-scales", nargs="+", type=float, default=[64, 128, 256])
    ...
    parser.add_argument("--total-pos-bboxes", type=int, default=128)
    parser.add_argument("--pool-size", nargs="+", type=int, default=[7, 7])
    parser.add_argument("--variances", nargs="+", type=float, default=[0.1, 0.1, 0.2, 0.2])
